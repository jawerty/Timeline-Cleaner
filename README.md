...
Timeline Cleaner is a Chrome extension that labels every post on X/Twitter with the account's declared region and lets you dial down—or completely hide—content from places you don't want in your feed. It runs entirely in your browser, piggybacks on public About Account endpoints, and never uploads your data anywhere else.
